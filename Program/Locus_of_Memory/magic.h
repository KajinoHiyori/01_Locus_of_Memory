...
typedef enum MAGICEVENT
{
	...
	MAGICEVENT_001,				// 家
	MAGICEVENT_002,				// 橋
	MAGICEVENT_003,				// 植物[成長/燃焼]
	MAGICEVENT_004,				// 植物[巻き戻し]
	MAGICEVENT_005,				// 池の氷結
	MAGICEVENT_006,				// 池が溶ける
	MAGICEVENT_007,				// 花[成長/燃焼]
	MAGICEVENT_008,				// 花[巻き戻し]
	MAGICEVENT_009,				// ドラゴンが眩しがる
	MAGICEVENT_010,				// 街灯に灯りをともす
	MAGICEVENT_011,				// 鍛冶場に火をつける
	MAGICEVENT_012,				// 焚火に火をつける
	MAGICEVENT_013,				// 篝火に火をつける
