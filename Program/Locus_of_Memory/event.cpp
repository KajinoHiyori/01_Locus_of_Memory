...
// マクロ定義
//=============================================================================
#define BLACKSMITH_POS_FIRE		(D3DXVECTOR3(-3200.0f, 45.0f, 950.0f))		// 鍛冶場の位置
#define BLACKSMITH_POS_SMOKE	(D3DXVECTOR3(-3200.0f, 500.0f, 980.0f))		// 鍛冶場の煙を設置
#define DRAGONFLASH_POS			(D3DXVECTOR3(2220.0f, 1000.0f, -4410.0f))	// ドラゴンに閃光を設置
