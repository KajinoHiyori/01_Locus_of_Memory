...
#define MOSTCOMMANDSOLO_POS		(D3DXVECTOR3(-40.0f, 30.0f, 0.0f))
#define COMMANDTYPESOLO_POS		(D3DXVECTOR3(0.0f, 30.0f, 0.0f))
...
#define YOUARE_POS				(D3DXVECTOR3(-40.0f, 15.0f, 0.0f))
#define COMMANDRESULT_POS		(D3DXVECTOR3(-40.0f, 10.0f, 0.0f))
#define CLEARRESULT_POS			(D3DXVECTOR3(20.0f, 10.0f, 0.0f))
#define EVENTRESULT_POS			(D3DXVECTOR3(20.0f, 10.0f, 0.0f))
...
void SetResultUI1P(void)
{
	...
	// 1番使ったコマンド
	SetResultUI(RESULTUITYPE_MOSTCOMMANDSOLO, RESULTUITEX_MOSTCOMMAND, MOSTCOMMANDSOLO_POS);
	// コマンドの種類[solo]
...
void SetResultUI(RESULTUITYPE type, RESULTUITEX tex, D3DXVECTOR3 pos)
{
	...
	for (int nCntUI = 0; nCntUI < NUM_RESULTUI; nCntUI++)
	{
		...
		case RESULTUITYPE_MOSTCOMMANDSOLO:	// 1番使ったコマンド[solo]
